...
class MainWidget(Widget):
    ...
    from useer_actions import _keyboard_closed, _on_keyboard_up, _on_keyboard_down, on_touch_up, on_touch_down
    ...
    def get_tile_coordinates(self, ti_x, ti_y):
        ...
        y = self.get_line_x_from_index(ti_y)
        return x, y
